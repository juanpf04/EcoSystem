...
public class MapViewer extends AbstractMapViewer {
	...
	// Anchura/altura/ de la simulaci�n -- se supone que siempre van a ser iguales
	// al tama�o del componente
	private int _width;
	private int _height;

	// N�mero de filas/columnas de la simulaci�n
	private int _rows;
	private int _cols;

	// Anchura/altura de una regi�n
	int _rwidth;
	int _rheight;

	// Mostramos s�lo animales con este estado. Los posibles valores de _currState
